RACCHECK TITLE 'FTP User Login Processor'
***********************************************************************
***                                                                 ***
*** Program:  RACCHECK                                              ***
***                                                                 ***
...
RACCHECK CSECT ,                start of program
         STM   R14,R12,12(R13)  save registers
         L     R2,8(,R13)       \
         LA    R14,96(,R2)       \
         L     R12,0(,R13)        \
         CL    R14,4(,R12)         \
         BL    F1-RACCHECK+4(,R15)  \
...
F1       DS    0H                  /
         ...
         USING RACCHECK,R12     tell assembler of base
